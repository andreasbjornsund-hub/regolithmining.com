...
en: {
    ...
    dispatch5: {
        date: "Lunar Dispatch #5 — February 28, 2026",
        title: "Isaacman Rewrites Artemis — No Landing Until 2028, But NASA Wants to Move Faster",
        subtitle: "NASA cancels SLS Block 1B, inserts a new LEO docking mission, and pushes the first crewed lunar landing to Artemis 4 in 2028. The logic: fly more often, take smaller steps, and beat China. Here's what it means for the mining timeline.",
        h1: "The Apollo 9 Moment",
        p1: "On February 27 — one week before Artemis II's planned March 6 launch — NASA Administrator Jared Isaacman announced the most significant restructuring of the Artemis program since its creation. The old Artemis 3 crewed lunar landing? Renamed Artemis 4 and pushed to 2028. In its place: a new Artemis 3 mission in 2027 that will test lander docking in low Earth orbit without going anywhere near the Moon.",
        p2: "Isaacman explicitly compared the new mission to Apollo 9 — the 1969 flight that tested the Lunar Module in Earth orbit before Apollo 10 and 11 ventured to the Moon. \"A wide objective gap between missions is also not a pathway to success,\" he said at the briefing. \"We didn't go right to Apollo 11.\"",
        p3: "The Aerospace Safety Advisory Panel (ASAP) had previously warned that the original Artemis 3 plan was dangerously ambitious — cramming too many first-time activities into a single mission. Isaacman's restructuring addresses that directly, even though he said the changes weren't coordinated with ASAP.",
        h2: "SLS Block 1B Is Dead",
        p4: "Buried in the announcement was a bombshell for the launch vehicle industry: NASA is canceling the SLS Block 1B upgrade entirely. The Block 1B would have replaced the Interim Cryogenic Propulsion Stage (ICPS) with a larger Exploration Upper Stage (EUS). Instead, all future SLS flights will use a \"near Block 1\" configuration — details unspecified.",
        p5: "The rationale is flight rate. Isaacman has been vocal about SLS launching only once every three years: \"When you're launching every three years, your skills atrophy.\" By standardizing on a simpler vehicle, NASA hopes to launch more frequently — even if each flight carries less to deep space.",
        p6: "Boeing, the SLS prime contractor and builder of the now-cancelled EUS, endorsed the plan. \"Our workforce and supply chain are prepared to meet the increased production needs,\" said Steve Parker of Boeing Defense, Space and Security. Lockheed Martin, the Orion contractor, called it a \"bold decision.\"",
        h3: "Artemis II: Days Away",
        p7: "Lost in the Artemis restructuring news: Artemis II is still on track for March 6. The four-person crew — Reid Wiseman, Victor Glover, Christina Koch, and Jeremy Hansen — will fly around the Moon and back in a 10-day mission. It will be the first crewed flight beyond low Earth orbit since Apollo 17 in December 1972.",
        p8: "The mission remains a critical proof point. If Artemis II succeeds, it validates Orion's life support, navigation, and heat shield in the deep-space environment. If it encounters problems, the new Artemis 3 docking mission in LEO provides an intermediate step before attempting anything on the lunar surface.",
        h4: "What This Means for Lunar Mining",
        p9: "At first glance, pushing the crewed landing to 2028 looks like bad news for anyone counting on a permanent human presence to enable large-scale extraction. But the picture is more nuanced:",
        li1: "Higher flight rate = more delivery opportunities. If NASA can launch SLS annually instead of every three years, the pipeline for surface payloads expands dramatically — including mining equipment.",
        li2: "The commercial landers are unaffected. Blue Origin's Blue Moon and SpaceX's Starship HLS are on their own development timelines. The new Artemis 3 actually tests these landers in LEO, potentially accelerating their readiness.",
        li3: "China's timeline didn't change. Chang'e 7 launches in August 2026 regardless of what NASA does. The geopolitical driver for faster lunar development remains intact.",
        li4: "Robotic mining doesn't need astronauts. Interlune's 2027 resource development mission, the Australian oxygen extraction rover, and CLPS deliveries all proceed independently of Artemis crewed landing dates.",
        h5: "The Wet Dress Rehearsal Question",
        p10: "Meanwhile, a less dramatic but potentially consequential issue lingers: Artemis II's Wet Dress Rehearsal (WDR) — the final full countdown test before launch — has been extended due to technical issues, including the hydrogen leaks that plagued Artemis I in 2022.",
        p11: "If the March 6 date slips, it would be the latest in a long chain of Artemis delays — and would validate Isaacman's argument that the current approach of launching infrequently with maximum complexity is unsustainable.",
        h6: "Our Take",
        p12: "Isaacman's restructuring is the most pragmatic thing to happen to Artemis since its inception. The original plan tried to leap from \"unmanned test flight\" to \"crewed lunar landing\" in a single step. That's not how Apollo worked, and it's not how engineering works.",
        p13: "For the mining industry, the real question was never \"when does a NASA astronaut step on the Moon?\" It's \"when does reliable, frequent delivery to the lunar surface become routine?\" A faster SLS cadence and flight-proven commercial landers answer that question better than a single heroic landing in 2027 would have.",
        p14: "The grey frontier just got a more realistic timeline. And realistic timelines are what investors fund.",
        sources: "Sources",
        prev: "← February 2026"
    }
},
no: {
    ...
    dispatch5: {
        date: "Månebulletin #5 — 28. februar 2026",
        title: "Isaacman skriver om Artemis — Ingen landing før 2028, men NASA vil gå raskere",
        subtitle: "NASA kansellerer SLS Block 1B, legger inn et nytt LEO-dokkingsoppdrag, og skyver den første bemannede månelandingen til Artemis 4 i 2028. Logikken: fly oftere, ta mindre steg, slå Kina.",
        h1: "Apollo 9-øyeblikket",
        p1: "27. februar — én uke før Artemis IIs planlagte oppskytning 6. mars — kunngjorde NASA-administrator Jared Isaacman den mest betydningsfulle omstruktureringen av Artemis-programmet siden opprettelsen. Den gamle Artemis 3 bemannede månelandingen? Omdøpt til Artemis 4 og utsatt til 2028. I stedet: et nytt Artemis 3-oppdrag i 2027 som tester landerdokking i lav jordbane.",
        p2: "Isaacman sammenlignet oppdraget med Apollo 9 — 1969-flyvningen som testet månemodulen i jordbane. «Et stort objektiv-gap mellom oppdrag er heller ikke veien til suksess», sa han. «Vi gikk ikke rett til Apollo 11.»",
        p3: "Sikkerhetsrådgivningspanelet ASAP hadde advart om at den opprinnelige Artemis 3-planen var farlig ambisiøs.",
        h2: "SLS Block 1B er død",
        p4: "NASA kansellerer SLS Block 1B-oppgraderingen helt. Alle fremtidige SLS-flyvninger vil bruke en «nær Block 1»-konfigurasjon.",
        p5: "Begrunnelsen er flytakt. Isaacman: «Når du skyter opp hvert tredje år, forvitrer ferdighetene dine.»",
        p6: "Boeing støtter planen. Lockheed Martin kaller det en «dristig beslutning».",
        h3: "Artemis II: Dager unna",
        p7: "Artemis II er fortsatt på sporet for 6. mars. Fire astronauter vil fly rundt månen i 10 dager — den første bemannede flyvningen utenfor lav jordbane siden 1972.",
        p8: "Oppdraget validerer Orions livsstøtte, navigasjon og varmeskjold i dypt rom.",
        h4: "Hva dette betyr for gruvedrift på månen",
        p9: "Ved første øyekast ser utsettelsen av den bemannede landingen til 2028 ut som dårlige nyheter. Men bildet er mer nyansert:",
        li1: "Høyere flytakt = flere leveringsmuligheter til overflaten, inkludert gruveutstyr.",
        li2: "De kommersielle landerne er upåvirket. Blue Moon og Starship HLS følger sine egne tidslinjer.",
        li3: "Kinas tidslinje endret seg ikke. Chang'e 7 skytes opp i august 2026 uansett.",
        li4: "Robotgruvedrift trenger ikke astronauter. Interlunes 2027-oppdrag og CLPS-leveranser fortsetter uavhengig.",
        h5: "Spørsmålet om våtøvelsen",
        p10: "Artemis IIs Wet Dress Rehearsal har blitt forlenget på grunn av tekniske problemer, inkludert hydrogenlekkasjer.",
        p11: "Hvis 6. mars-datoen glir, bekrefter det Isacmans argument om at sjelden oppskyting med maksimal kompleksitet er uholdbar.",
        h6: "Vår vurdering",
        p12: "Isaacmans omstrukturering er det mest pragmatiske som har skjedd med Artemis. Den opprinnelige planen forsøkte å hoppe fra ubemannet testflytur til bemannet månelanding i ett steg.",
        p13: "For gruveindustrien var spørsmålet aldri «når lander en NASA-astronaut?» Det er «når blir pålitelig, hyppig levering til måneoverflaten rutine?» Raskere SLS-takt og flytestede kommersielle landere svarer bedre enn én heroisk landing i 2027.",
        p14: "Den grå fronten har fått en mer realistisk tidslinje. Og realistiske tidslinjer er det investorer finansierer.",
        sources: "Kilder",
        prev: "← Februar 2026"
    }
},
de: {
    ...
    dispatch4: { date: "Mond-Depesche #4 — 24. Februar 2026", title: "Artemis II rollt zur Startrampe — Die Menschheit kehrt ins tiefe All zurück", subtitle: "Die bedeutendste bemannte Raumfahrtmission seit 54 Jahren steht kurz bevor.", h1: "Artemis II: Start am 6. März", p1: "Am 17. Januar rollte NASAs Space Launch System mit der Orion-Kapsel zur Startrampe 39B am Kennedy Space Center. Artemis II zielt nun auf den 6. März 2026.", p2: "Vier Astronauten werden 10 Tage auf einer Bahn um den Mond und zurück verbringen — weiter als jeder Mensch seit Gene Cernan 1972.", p3: "Für die Bergbauindustrie validiert Artemis II das Transportsystem, das letztendlich Bergbauausrüstung zur Oberfläche liefern wird.", h2: "Interlune sichert NASA-Bagger-Vertrag", p4: "Interlune erhielt einen NASA-Vertrag zur Entwicklung eines Mondbaggers, optimiert für die raue Mondumgebung.", p5: "Die aktuelle Phase soll bis Mitte 2026 abgeschlossen sein. Interlune hat die glaubwürdigste Zeitlinie aller Mondbergbauunternehmen.", h3: "Chinas Chang'e 7: Der Wettbewerb verschärft sich", p6: "Chinas Chang'e 7, geplant für August 2026, wird die ambitionierteste robotische Mondmission aller Zeiten.", p7: "Die Landefähre zielt auf Shackleton-Kraters beleuchteten Rand — eine der begehrtesten Immobilien im Sonnensystem.", p8: "China hat die Artemis-Abkommen nicht unterzeichnet. Ihr ILRS-Programm mit Russland stellt ein paralleles Governance-Framework dar.", h4: "Indien wählt seinen Landeplatz", p9: "ISRO hat MM-4 bei Mons Mouton als Ziel für die nächste Mondmission identifiziert.", p10: "Indiens Ansatz ist methodisch: Chandrayaan-4 für Probenrückführung, dann Daten für Ressourcenmissionen nutzen.", h5: "Die Südpol-Konvergenz", p11: "Zählen Sie die Akteure, die jetzt auf die Südpolregion des Mondes zielen:", li1: "NASA / Artemis III — Bemannte Landung, Mitte 2027", li2: "China / Chang'e 7 — Robotisch, August 2026", li3: "Indien / Chandrayaan-4 — Probenrückführung, Datum offen", li4: "Interlune — Ressourcenmission, 2027", li5: "Intuitive Machines / IM-3 — Robotische Landefähre, H2 2026", li6: "Blue Origin / Blue Moon — Frachttransporter, 2026-2027", li7: "Australien — Bergbaurover, 2026", p12: "Sieben Programme, ein Ziel. Die Drängerei wirft Fragen auf, die der aktuelle Rechtsrahmen nicht beantworten kann.", h6: "Unsere Einschätzung", p13: "Februar 2026 fühlt sich wie ein Wendepunkt an. Die Hardware ist real, die Missionen finanziert, der politische Wille vorhanden.", p14: "Die Unternehmen und Nationen, die jetzt investieren, werden die cis-lunare Wirtschaft für das nächste Jahrhundert definieren.", sources: "Quellen", prev: "← Januar 2026", next: "März 2026 →" },
    dispatch5: { date: "Mond-Depesche #5 — 28. Februar 2026", title: "Isaacman schreibt Artemis um — Keine Landung bis 2028, aber NASA will schneller", subtitle: "NASA streicht SLS Block 1B, fügt eine LEO-Docking-Mission ein und verschiebt die erste bemannte Mondlandung auf Artemis 4 im Jahr 2028.", h1: "Der Apollo-9-Moment", p1: "Am 27. Februar kündigte NASA-Administrator Jared Isaacman die größte Umstrukturierung des Artemis-Programms an. Die alte Artemis 3 bemannte Mondlandung wird zu Artemis 4 und verschiebt sich auf 2028. Stattdessen: ein neues Artemis 3 in 2027, das die Lander-Docking in der niedrigen Erdumlaufbahn testet.", p2: "Isaacman verglich die Mission mit Apollo 9. «Ein großer Ziel-Sprung zwischen Missionen ist auch kein Weg zum Erfolg. Wir sind nicht direkt zu Apollo 11 gesprungen.»", p3: "Das ASAP-Sicherheitspanel hatte zuvor gewarnt, dass der ursprüngliche Artemis-3-Plan gefährlich ambitioniert war.", h2: "SLS Block 1B ist tot", p4: "NASA streicht die SLS Block 1B-Aufrüstung vollständig. Alle zukünftigen Flüge nutzen eine «nahezu Block 1»-Konfiguration.", p5: "Die Begründung: Flugrate. «Wenn man alle drei Jahre startet, verkümmern die Fähigkeiten.»", p6: "Boeing und Lockheed Martin unterstützen den Plan.", h3: "Artemis II: Tage entfernt", p7: "Artemis II bleibt auf Kurs für den 6. März. Vier Astronauten umrunden den Mond in 10 Tagen.", p8: "Die Mission validiert Orions Lebenserhaltung und Hitzeschild im Weltraum.", h4: "Was das für Mondbergbau bedeutet", p9: "Auf den ersten Blick sieht die Verschiebung nach schlechten Nachrichten aus. Aber:", li1: "Höhere Flugrate = mehr Liefermöglichkeiten für Bergbauausrüstung.", li2: "Kommerzielle Lander sind nicht betroffen. Blue Moon und Starship HLS folgen eigenen Zeitplänen.", li3: "Chinas Zeitplan hat sich nicht geändert. Chang'e 7 startet im August 2026.", li4: "Robotischer Bergbau braucht keine Astronauten. Interlunes Mission 2027 läuft unabhängig.", h5: "Die Wet-Dress-Rehearsal-Frage", p10: "Die Generalprobe von Artemis II wurde wegen technischer Probleme verlängert, einschließlich Wasserstofflecks.", p11: "Wenn der 6. März verschoben wird, bestätigt das Isaacmans Argument gegen seltene, komplexe Starts.", h6: "Unsere Einschätzung", p12: "Isaacmans Umstrukturierung ist das Pragmatischste, was Artemis je passiert ist.", p13: "Für die Bergbauindustrie war die Frage nie «Wann landet ein Astronaut?» sondern «Wann wird zuverlässige Lieferung Routine?»", p14: "Die graue Grenze hat einen realistischeren Zeitplan bekommen. Und realistische Zeitpläne sind das, was Investoren finanzieren.", sources: "Quellen", prev: "← Februar 2026" }
},
sv: {
    ...
    dispatch4: { date: "Månbulletin #4 — 24 februari 2026", title: "Artemis II rullar till rampen — Mänskligheten återvänder till djupa rymden", subtitle: "Det mest betydelsefulla bemannade rymduppdraget på 54 år.", h1: "Artemis II: Uppskjutning 6 mars", p1: "NASAs Space Launch System med Orion-kapseln rullade ut till Launch Complex 39B den 17 januari. Artemis II siktar på 6 mars 2026.", p2: "Fyra astronauter kommer att färdas runt månen — längre än någon människa sedan 1972.", p3: "Artemis II validerar transportsystemet som slutligen ska leverera utrustning till ytan.", h2: "Interlune säkrar NASA-grävmaskinskontrakt", p4: "Interlune erhöll ett NASA-kontrakt för att utveckla en mångrävmaskin.", p5: "Arbetet ska slutföras till mitten av 2026. Interlune har den mest trovärdiga tidslinjen.", h3: "Kinas Chang'e 7", p6: "Kinas Chang'e 7, planerat till augusti 2026, blir det mest ambitiösa robotiska månuppdraget.", p7: "Landaren siktar på Shackleton-kraterns belysta kant.", p8: "Kina har inte undertecknat Artemis-avtalen.", h4: "Indien väljer sin landningsplats", p9: "ISRO har identifierat MM-4 vid Mons Mouton som mål.", p10: "Indiens tillvägagångssätt är metodiskt.", h5: "Sydpolskonvergensen", p11: "Räkna aktörerna som nu siktar på månens sydpol:", li1: "NASA / Artemis III — 2027", li2: "Kina / Chang'e 7 — Augusti 2026", li3: "Indien / Chandrayaan-4 — Datum ej bestämt", li4: "Interlune — 2027", li5: "Intuitive Machines / IM-3 — H2 2026", li6: "Blue Origin / Blue Moon — 2026-2027", li7: "Australien — Gruvrover, 2026", p12: "Sju program, en destination. Trängseln väcker frågor som nuvarande regelverk inte kan besvara.", h6: "Vår bedömning", p13: "Februari 2026 känns som en vändpunkt. Hårdvaran är verklig, uppdragen finansierade.", p14: "De som investerar nu kommer att definiera den cis-lunära ekonomin.", sources: "Källor", prev: "← Januari 2026", next: "Mars 2026 →" },
    dispatch5: { date: "Månbulletin #5 — 28 februari 2026", title: "Isaacman skriver om Artemis — Ingen landning förrän 2028, men NASA vill gå snabbare", subtitle: "NASA stryker SLS Block 1B, lägger till en LEO-dockningstest och skjuter första bemannade landningen till 2028.", h1: "Apollo 9-ögonblicket", p1: "Den 27 februari meddelade NASA-chefen Jared Isaacman den största omstruktureringen av Artemis. Gamla Artemis 3 bemannade landning blir Artemis 4, flyttad till 2028. Istället: ny Artemis 3 i 2027 som testar landardockning i låg omloppsbana.", p2: "Isaacman jämförde uppdraget med Apollo 9. «Ett stort målgap mellan uppdrag är inte heller vägen till framgång.»", p3: "Säkerhetspanelen ASAP hade varnat att den ursprungliga planen var farligt ambitiös.", h2: "SLS Block 1B är dött", p4: "NASA stryker SLS Block 1B-uppgraderingen helt. Alla framtida flygningar använder «nära Block 1».", p5: "Logiken: flygfrekvens. «När man skjuter upp vart tredje år förtvinar kompetensen.»", p6: "Boeing och Lockheed Martin stödjer planen.", h3: "Artemis II: Dagar kvar", p7: "Artemis II siktar fortfarande på 6 mars. Fyra astronauter runt månen i 10 dagar.", p8: "Uppdraget validerar Orions system i djupa rymden.", h4: "Vad detta betyder för mångruvdrift", p9: "Vid första anblicken ser förseningen ut som dåliga nyheter. Men:", li1: "Högre flygfrekvens = fler leveransmöjligheter för gruvutrustning.", li2: "Kommersiella landare påverkas inte. Blue Moon och Starship HLS följer egna tidslinjer.", li3: "Kinas tidslinje ändrades inte. Chang'e 7 skjuts upp i augusti 2026.", li4: "Robotgruvdrift behöver inte astronauter.", h5: "Frågan om våttestet", p10: "Artemis II:s Wet Dress Rehearsal har förlängts på grund av tekniska problem.", p11: "Om 6 mars glider bekräftar det Isaacmans argument.", h6: "Vår bedömning", p12: "Isaacmans omstrukturering är det mest pragmatiska som hänt Artemis.", p13: "Frågan var aldrig «när landar en astronaut?» utan «när blir pålitlig leverans rutin?»", p14: "Den grå fronten fick en mer realistisk tidslinje.", sources: "Källor", prev: "← Februari 2026" }
},
nl: {
    ...
    dispatch4: { date: "Maandepeche #4 — 24 februari 2026", title: "Artemis II rolt naar het lanceerplatform — De mensheid keert terug naar de diepe ruimte", subtitle: "De belangrijkste bemande ruimtemissie in 54 jaar.", h1: "Artemis II: Lancering 6 maart", p1: "NASA's SLS met de Orion-capsule rolde uit naar Launch Complex 39B. Artemis II mikt op 6 maart 2026.", p2: "Vier astronauten zullen 10 dagen rond de maan reizen — verder dan enig mens sinds 1972.", p3: "Artemis II valideert het transportsysteem voor toekomstige leveringen aan het oppervlak.", h2: "Interlune wint NASA-graafmachinecontract", p4: "Interlune ontving een NASA-contract voor een maangraafmachine.", p5: "Het werk moet medio 2026 zijn afgerond.", h3: "China's Chang'e 7", p6: "China's Chang'e 7, gepland voor augustus 2026, wordt de meest ambitieuze robotische maanmissie ooit.", p7: "De lander mikt op de verlichte rand van de Shackleton-krater.", p8: "China heeft de Artemis-akkoorden niet ondertekend.", h4: "India kiest zijn landingsplaats", p9: "ISRO heeft MM-4 bij Mons Mouton geïdentificeerd.", p10: "India's benadering is methodisch.", h5: "De zuidpool-convergentie", p11: "Tel de entiteiten die nu op de zuidpool mikken:", li1: "NASA / Artemis III — 2027", li2: "China / Chang'e 7 — Augustus 2026", li3: "India / Chandrayaan-4 — Datum onbekend", li4: "Interlune — 2027", li5: "Intuitive Machines / IM-3 — H2 2026", li6: "Blue Origin / Blue Moon — 2026-2027", li7: "Australië — Mijnbouwrover, 2026", p12: "Zeven programma's, één bestemming.", h6: "Onze beoordeling", p13: "Februari 2026 voelt als een kantelpunt.", p14: "De bedrijven en naties die nu investeren zullen de cis-lunaire economie definiëren.", sources: "Bronnen", prev: "← Januari 2026", next: "Maart 2026 →" },
    dispatch5: { date: "Maandepeche #5 — 28 februari 2026", title: "Isaacman herschrijft Artemis — Geen landing tot 2028, maar NASA wil sneller", subtitle: "NASA annuleert SLS Block 1B, voegt een LEO-dockingtest toe en verschuift de eerste bemande landing naar 2028.", h1: "Het Apollo 9-moment", p1: "Op 27 februari kondigde NASA-baas Jared Isaacman de grootste herstructurering van Artemis aan. De oude Artemis 3 bemande landing wordt Artemis 4, verschoven naar 2028. In plaats daarvan: een nieuwe Artemis 3 in 2027 die lander-docking in lage baan test.", p2: "Isaacman vergeleek de missie met Apollo 9. «Een groot doelgat tussen missies is ook geen pad naar succes.»", p3: "Het ASAP-veiligheidspanel had gewaarschuwd dat het oorspronkelijke plan te ambitieus was.", h2: "SLS Block 1B is dood", p4: "NASA annuleert de SLS Block 1B-upgrade volledig.", p5: "De logica: vluchtfrequentie. «Als je elke drie jaar lanceert, verlies je vaardigheden.»", p6: "Boeing en Lockheed Martin steunen het plan.", h3: "Artemis II: Nog enkele dagen", p7: "Artemis II mikt nog steeds op 6 maart. Vier astronauten rond de maan in 10 dagen.", p8: "De missie valideert Orions systemen in de diepe ruimte.", h4: "Wat dit betekent voor maanmijnbouw", p9: "Op het eerste gezicht lijkt uitstel slecht nieuws. Maar:", li1: "Hogere vluchtfrequentie = meer leveringsmogelijkheden voor mijnbouwapparatuur.", li2: "Commerciële landers worden niet beïnvloed.", li3: "China's tijdlijn is ongewijzigd. Chang'e 7 lanceert in augustus 2026.", li4: "Robotmijnbouw heeft geen astronauten nodig.", h5: "De Wet Dress Rehearsal-vraag", p10: "De generale repetitie van Artemis II is verlengd wegens technische problemen.", p11: "Als 6 maart verschuift, bevestigt dat Isaacmans argument.", h6: "Onze beoordeling", p12: "Isaacmans herstructurering is het meest pragmatische dat Artemis is overkomen.", p13: "De vraag was nooit «wanneer landt een astronaut?» maar «wanneer wordt betrouwbare levering routine?»", p14: "De grijze grens heeft een realistischer tijdlijn gekregen.", sources: "Bronnen", prev: "← Februari 2026" }
},
ja: {
    ...
    dispatch5: { date: "月面速報 #5 — 2026年2月28日", title: "アイザックマンがアルテミスを書き換え — 2028年まで着陸なし、しかしNASAは加速を目指す", subtitle: "NASAがSLS Block 1Bを中止、LEOドッキングテストを追加し、初の有人月面着陸を2028年のアルテミス4に延期。", h1: "アポロ9の瞬間", p1: "2月27日、NASA長官ジャレド・アイザックマンがアルテミス計画最大の再編を発表。旧アルテミス3の有人月面着陸はアルテミス4に改名、2028年に延期。代わりに2027年の新アルテミス3で低軌道でのランダードッキングをテスト。", p2: "アイザックマンはアポロ9と比較。「ミッション間の大きな目標ギャップも成功への道ではない。アポロ11に直接飛んだわけではない。」", p3: "安全諮問パネルASAPは元のアルテミス3計画が危険なほど野心的だと警告していた。", h2: "SLS Block 1Bは終了", p4: "NASAはSLS Block 1Bアップグレードを完全に中止。すべての将来の飛行は「ニアBlock 1」構成を使用。", p5: "理由は飛行頻度。「3年に1回の打ち上げでは技術が衰退する。」", p6: "ボーイングとロッキード・マーティンが計画を支持。", h3: "アルテミスII：あと数日", p7: "アルテミスIIは3月6日の予定通り。4人の宇宙飛行士が10日間で月を周回。", p8: "オリオンの生命維持システムと耐熱シールドを深宇宙で検証。", h4: "月面採掘への意味", p9: "一見、有人着陸の2028年延期は悪いニュース。しかし：", li1: "飛行頻度の向上 = 採掘機器を含む配送機会の拡大。", li2: "商業着陸機は影響なし。Blue MoonとStarship HLSは独自のタイムライン。", li3: "中国のタイムラインは変わらず。嫦娥7号は2026年8月に打ち上げ。", li4: "ロボット採掘に宇宙飛行士は不要。Interluneの2027年ミッションは独立して進行。", h5: "ウェットドレスリハーサルの問題", p10: "アルテミスIIの最終カウントダウンテストが技術的問題で延長中。", p11: "3月6日が延期されれば、アイザックマンの議論が正当化される。", h6: "私たちの見解", p12: "アイザックマンの再編はアルテミス史上最も現実的な判断。", p13: "採掘産業の本当の問題は「宇宙飛行士がいつ着陸するか」ではなく「月面への信頼性の高い定期配送がいつ日常になるか」。", p14: "灰色のフロンティアがより現実的なタイムラインを得た。そして現実的なタイムラインこそ投資家が資金を出すもの。", sources: "出典", prev: "← 2026年2月" }
}
};
